...
from minglu.models import gssldata,gszxdata
...
def show(request):
    ...
    c = {'posts': posts,'title':'长沙市商事登记平台企业信息','exportfiletype':'ssqy'}
...
def showzhuxiao(request):
    ...
    t = loader.get_template('slzlx.html')
...
def showqyxx(request):
    ...
    t = loader.get_template('qyxx.html')
...
def querydata(request):
    ...
    #return HttpResponse(t.render(c))
    #return render(request, 'query.html', {'form': c})
    return render_to_response('query.html', {'form': c})    
